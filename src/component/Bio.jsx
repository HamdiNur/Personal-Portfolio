...
import './bio.css';
import AboutImg from "../assets/../assets/Hamdi Nur assets/bios.jpg";
import CV from "../assets/Hamdi Nur assets/Hamdi-Cv.pdf";
...
const Bio = () => {
  return (
    <section   id="bio" className="about section">
      <h2 className="section__title">
         About <span className="two"> Me</span></h2>
